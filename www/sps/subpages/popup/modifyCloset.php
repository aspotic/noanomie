			...
			<?php if (isset($_POST['createCloset'])) { ?>
				<form id="popupForm" action="<?php echo $homeDir; ?>" method="post">
					<ul>
						...
						<li><input id="text" type="text" name="name" value="Name" onClick="javascript: this.select();"  />				</li>
						<li><input id="text" type="text" name="description" value="Description" onClick="javascript: this.select();"  /></li>
						<li><input id="createButton" type="submit" name="doCreateCloset" value="Create Closet" />						</li>
			...
			<?php } else if (isset($_POST['editCloset'])) { ?>
				<form id="popupForm" action="<?php echo $homeDir; ?>" method="post">
					<ul>
						...
						<li><input id="text" type="text" name="name" value="Name" onClick="javascript: this.select();"  />	</li>
						<li><input id="createButton" type="submit" name="doEditCloset" value="Update Closet" />				</li>
						<li><input id="button" type="submit" name="cancel" value="Cancel" />								</li>
						<li><input type="hidden" name="schoolName" value="<?php echo $_POST['schoolName']; ?>" />			</li>
						<li><input type="hidden" name="seeCD" value="1" />													</li>
					</ul>
			...
			<?php } else if (isset($_POST['removeCloset'])) { ?>
				<form id="popupForm" action="<?php echo $homeDir; ?>" method="post">
					<ul>
						...
						<li><input id="destroyButton" type="submit" name="doRemoveCloset" value="Yes" />										</li>
