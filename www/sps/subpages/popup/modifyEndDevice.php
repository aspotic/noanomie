				...
				<form id="popupForm" action="<?php echo $homeDir; ?>" method="post">
					<table>
						...
						<tr>
							...
							<th>
								<input id="text" type="text" name="room" value="" onClick="javascript: this.select();" />
							</th>
						</tr>		
						<tr>
							<th>
							...
							<th>
								<input id="text" type="text" name="closet" value="" onClick="javascript: this.select();" />
							</th>
						</tr>		
						<tr>
							<th>
							...
							<th>
								<input id="text" type="text" name="panel" value="" onClick="javascript: this.select();" />
							</th>
						</tr>		
						<tr>
							<th>
							...
							<th>
								<input id="text" type="text" name="port" value="" onClick="javascript: this.select();" />
							</th>
						</tr>	
						<tr>
							<th>
