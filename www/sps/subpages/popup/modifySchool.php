			...
			<?php if (isset($_POST['createSchool'])) { ?>
				<form id="popupForm" action="<?php echo $homeDir; ?>" method="post">
					<ul>
						...
						<li><input id="text" type="text" name="schoolName" value="School Name" onClick="javascript: this.select();" />			</li>
						<li><input id="text" type="text" name="schoolID" value="School ID" onClick="javascript: this.select();" />				</li>
				...
				if ($row = mysql_fetch_assoc($result)) { ?>
					<form id="popupForm" action="<?php echo $homeDir; ?>" method="post">
						<ul>
							...
							<li><input id="text" type="text" name="schoolName" value="<?php echo $row['SchoolName'] ?>" onClick="javascript: this.select();" />	</li>
							<li><input id="text" type="text" name="schoolID" value="<?php echo $row['SchoolID'] ?>" onClick="javascript: this.select();" />	</li>
