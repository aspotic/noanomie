...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<?php
		...
		static $footerText = "NoAnomie.co.cc &copy; 2010";
...
jQuery(function() {
	...
	<link rel="StyleSheet" href="http://noanomie.0sites.net/stylesheets/<?php echo $layout_theme; ?>.css" type="text/css" />
	...
	<style type="text/css">
		body {
			...
			/*CSS3*/
			background:
				url(http://noanomie.0sites.net/images/back1mid.png) center center no-repeat,
				url(http://noanomie.0sites.net/images/back1tl.png) top left no-repeat,
				url(http://noanomie.0sites.net/images/back1tr.png) top right no-repeat,
				url(http://noanomie.0sites.net/images/back1bl.png) bottom left no-repeat,
				url(http://noanomie.0sites.net/images/back1br.png) bottom right no-repeat;
